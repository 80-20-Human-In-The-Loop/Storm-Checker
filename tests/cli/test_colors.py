...
def test_ansi_control_codes():
    ...
    for name, expected in control_codes.items():
        actual = globals().get(name) or getattr(sys.modules['cli.colors'], name)
...
def test_print_learn():
    ...
    from cli.colors import print_learn
    import io
    import sys
...
def test_demo_colors_function():
    ...
    from cli.colors import demo_colors
    import io
    import sys
...
def test_create_rich_style():
    ...
    from cli.colors import create_rich_style, RICH_AVAILABLE
...
def test_print_rich_functions():
    ...
    from cli.colors import print_rich_header, print_rich_success, print_rich_warning, print_rich_error, print_rich_info
    import io
    import sys
...
def test_color_printer_practice():
    ...
    from cli.colors import ColorPrinter
...
def test_get_rich_color():
    ...
    from cli.colors import get_rich_color, RICH_AVAILABLE
...
def test_print_rich_functions_with_rich_available():
    ...
    from cli.colors import print_rich_header, print_rich_success, print_rich_error, print_rich_warning, print_rich_info
    import io
    import sys
