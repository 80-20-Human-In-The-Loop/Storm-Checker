...
def test_get_rich_color_no_rich():
    ...
    with patch('storm_checker.cli.colors.RICH_AVAILABLE', False):
        from storm_checker.cli.colors import get_rich_color
...
def test_create_rich_style_no_rich():
    ...
    with patch('storm_checker.cli.colors.RICH_AVAILABLE', False):
        from storm_checker.cli.colors import create_rich_style
...
def test_demo_rich_integration_exception():
    ...
    from storm_checker.cli.colors import RICH_AVAILABLE, demo_rich_integration
...
def test_ansi_control_codes_edge_case():
    ...
    for code in control_codes:
        assert hasattr(storm_checker.cli.colors, code)
        value = getattr(storm_checker.cli.colors, code)
...
def test_color_printer_fallback_paths():
    ...
    from storm_checker.cli.colors import ColorPrinter, RICH_AVAILABLE
    ...
    try:
        ...
        import storm_checker.cli.colors
        storm_checker.cli.colors.RICH_AVAILABLE = False
        ...
        storm_checker.cli.colors.RICH_AVAILABLE = original_rich
